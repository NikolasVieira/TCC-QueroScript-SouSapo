...
<div class="container">
    ...
    <form id="frmhq" name="frmhq" action="{{ route('hq.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="form-group col">
                <label for="chapter_number">Capitulo N°</label>
        ...
        <div class="row">
            <div class="form-group col">
                <label for="page_number">Paginas</label>
                <input type="number" class="form-control {{ $errors->has('page_number') ? 'is-invalid' : ''}}" id="page_number"
                    name="page_number" placeholder="Informe o Número de paginas que terão nesse Capitulo">
